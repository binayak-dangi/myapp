  ...
  <footer className="py-5">
    ...
    <div className="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
      ...
      <ul className="list-unstyled d-flex">
        <li className="ms-3"><Link className="link-body-emphasis" to="#"><TfiFacebook/></Link></li>
        <li className="ms-3"><Link className="link-body-emphasis" to="#"><TfiInstagram/></Link></li>
        <li className="ms-3"><Link className="link-body-emphasis" to="#"><TfiTwitter/></Link></li>
      </ul>
    </div>
  </footer>
</div>
